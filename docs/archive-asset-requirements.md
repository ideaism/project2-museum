...
Agent 02 uses placeholder paths only. These files are required before the prototype can be presented as a verified object archive.
...
| `campaign-slogan-mug` | 3D model | `/assets/archive/models/campaign-slogan-mug.glb` | No-AR object detail viewer |
...
- Scale: exported model should fit comfortably in a 1 m viewer scene with the mug centered around the origin.
